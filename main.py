...
BOT_TOKEN = "Ur bot token"
ADMIN_CHAT_ID = "admin chat ID"
CHANNEL_LINK = "Ur bot link"
...
async def show_payment_details(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if method == 'telebirr':
        text = "Send *amount* ETB via Telebirr to 09*****"
    elif method == 'cbe':
        text = "Send *amount* ETB to CBE account 1000*****"
    else:
        text = "Send *amount* ETB to Awash account 0132*****"
